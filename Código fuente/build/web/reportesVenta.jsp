                            ...
                            <div class="card-body">
                                <div class="row d-flex justify-content-between">
                                    ...
                                    <div class="text-nowrap mb-3 d-flex justify-content-between">
                                        <div id="dataTable_length" class="dataTables_length mr-4" aria-controls="dataTable"><label for="start" class="label_fecha_inicio">Desde:</label><input type="date" id="" name="trip-start" class="fecha_inicio" value="dd/mm/aaaa"></div>

                                        <div id="dataTable_length" class="dataTables_length mr-2" aria-controls="dataTable"><label for="start" class="label_fecha_inicio">Hasta:</label><input type="date" id="" name="trip-start" class="fecha_inicio" value="dd/mm/aaaa"></div>

                                        <div id="dataTable_length" class="dataTables_length" aria-controls="dataTable">
                                            <button type="button" class="btn btn-outline-dark" title="Filtrar"><i class="fas fa-filter"></i></button></div>
                                    </div>
                                    
                                    <div class="text-nowrap d-flex justify-content-between">
                                        <div class="text-md-right dataTables_filter" id="dataTable_filter">
                                            <button type="button" class="btn btn-success" title="Imprimir" id="">
                                        ...
                                        <div class="text-md-right dataTables_filter ml-3 mr-3" id="dataTable_filter">
                                            <form action="ControladorPDF" method="POST">
                                                <button type="submit" class="btn btn-danger" name="accion" value="exportarPdfReporteVenta" title="Exportar PDF" id="exportarPdfReporteVenta">
