        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col derecha">
                    <h2 class="title text-center">Bienvenido a
                        <span class="title-bookware">BookWare</span>
                    </h2>

                    <h4 class="credenciales text-center">Ingrese credenciales de acceso</h4>
                    ...
                    <form action="ControladorGeneral" method="POST">
                        ...
                        <div class="form-group">
                          ...
                          <label for="passwordEmpresa">Contrase&ntilde;a</label>
                        ...
                        <div class="form-group form-check">
                          ...
                          <label class="form-check-label" for="checkRecuerdame">Recu&eacute;rdame</label>
                        </div>
                      
                        <div class="footer-form">
                            <button type="submit" class="btn btnSubmit" name="accion" value="Logear">Entrar</button>
                            <a class="olvidaste_contrasena text-center" data-toggle="modal" data-target="#modalRecuperaPass">¿Olvidaste tu contrase&ntilde;a?</a>
                        </div>
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              <div class="modal-body">
                                  <h4 class="text-center">Recupera tu contrase&ntilde;a</h4>

                                  <p class="">
                                      Comun&iacute;quese con el proveedor de su sistema para proporcionarle una nueva contrase&ntilde;a al correo: 
                                  </p>
