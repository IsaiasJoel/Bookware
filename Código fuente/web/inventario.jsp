                                ...
                                <div class="col-12">
                                    <nav>
                                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                            ...
                                            <a class="nav-link" id="nav-categorias-tab" data-toggle="tab" href="#nav-categorias" role="tab" aria-controls="nav-categorias" aria-selected="false">Categorías</a>
                                            <a class="nav-link" id="nav-subcategorias-tab" data-toggle="tab" href="#nav-subcategorias" role="tab" aria-controls="nav-subcategorias" aria-selected="false">Subcategorías</a>
                                    ...
                                    <div class="tab-content" id="nav-tabContent">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="ControladorGeneral" method="GET">
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="title-inventario" for="tituloLibro">Título:</label>
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form action="ControladorGeneral" method="GET">
                                                                                ...
                                                                                <!--cmb categoria-->
                                                                                <div class="form-group">
                                                                                    <label for="uCategoriaLibro">Categoría:</label>
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="modal fade" id="modalEliminarLibro" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="heading title-inventario">¿Estás seguro?</h5>
                                                                        </div>
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form action="ControladorGeneral" method="GET">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <button type="button" class="btn btn-light" data-dismiss="modal">Cancelar</button>
                                                                                    <button type="submit" class="btn  btn-outline-danger" name="accion" value="EliminarLibro">Sí, eliminar</button>
                                                                                </div>
                                                                            </form>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr id="tabla_vertical">
                                                                ...
                                                                <div class="modal fade right" id="modalEditarAutor" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="false">
                                                                    <div class="modal-dialog modal-full-height modal-right modal-notify modal-info" role="document">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <form action="ControladorGeneral" method="get">
                                                                                    <!--este input contendrá el id del autor a eliminar-->
                                                            ...
                                                            <td>
                                                                ...
                                                                <!--<a href="ControladorGeneral?accion=EliminarAutor&idEliminarAutor=acá va el ID">Sí, eliminar</a>-->
                                                                ...
                                                                <div class="modal fade" id="modalEliminarAutor" tabindex="-1" aria-labelledby="modalEliminarAutor" aria-hidden="true">
                                                                    <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h5 class="text-center">¿Estás seguro que deseas eliminar?</h5>
                                                                            </div>
                                        ...
                                        <div class="tab-pane fade" id="nav-categorias" role="tabpanel" aria-labelledby="nav-categorias-tab">
                                            <br>
                                            <h3 class="title-inventario text-center">Categorías</h3>
                                            <hr>
                                            ...
                                            <div class="modal fade" id="modalAgregarCategoria" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-header">
                                                            <h4 class="modal-title title-inventario text-center">Registro de categoría</h4>
                                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                                        </div>
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="ControladorGeneral" method="GET">
                                                                <div class="form-group">
                                                                    <label for="nombreCategoria" class="title-inventario">Categoría:</label><br>
                                                                        ...
                                                                        <div class="modal-content text-center">
                                                                            <form action="ControladorGeneral" method="GET">
                                                                                <div class="modal-header d-flex justify-content-center">
                                                                                    <p class="heading">Estás seguro?</p>
                                                                                </div>
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    ...
                                                                                    <button type="submit" class="btn btn-outline-danger" name="accion" value="EliminarCategoria">Sí, eliminar</button>
                                                                                </div>
                                                                            </form>
                                                                        </div>
                                                                    </div>
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form action="ControladorGeneral" method="GET">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <button type="button" class="btn  btn-light" data-dismiss="modal">No, cancelar</button>
                                                                                    <button type="submit" class="btn btn-outline-danger" name="accion" value="EliminarEditorial">Sí, eliminar</button>
                                                                                </div>
                                                                            </form>
                                                                        </div>
                                                                    </div>
                                        ...
                                        <div class="tab-pane fade" id="nav-subcategorias" role="tabpanel" aria-labelledby="nav-subcategorias-tab">
                                            <br>
                                            <h3 class="title-inventario text-center">Subcategorías</h3>
                                            <hr>
                                            ...
                                            <div class="modal fade" id="modalAgregarSubcategoria">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-header">
                                                            <h5 class="modal-title title-inventario">Registro de subcategoría</h5>
                                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                                        </div>
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="ControladorGeneral" method="GET">
                                                                <div class="form-group">
                                                                    <label class="title-inventario" for="nombreSubcategoria">Subcategoría:</label><br>
                                                            ...
                                                            <td>
                                                                ...
                                                                <div class="modal fade" id="modalEditarSubcategoria" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                    <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h5 class="heading">Editar subcategoría</h5>
                                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                    <span aria-hidden="true" class="white-text">×</span>
                                                                                </button>
                                                                            </div>
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <form action="ControladorGeneral" method="GET">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <label for="uNombreSubcategoria">Subcategoría</label>
                                                                                        <input id="uNombreSubcategoria" class="form-control" type="text" name="uNombreSubcategoria">
                                                                                    </div>

                                                                                    <div class="form-group">
                                                                                        <label for="uNombreCategoria">Categoría: </label>
                                                            ...
                                                            <td>
                                                                ...
                                                                <div class="modal fade" id="modalEliminarSubcategoria" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                    <div class="modal-dialog">
                                                                        <div class="modal-content text-center">
                                                                            <div class="modal-header">
                                                                                <h5 class="heading">¿Estás seguro?</h5>
                                                                            </div>
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <form action="ControladorGeneral" method="GET">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <button type="button" class="btn  btn-light" data-dismiss="modal">Cancelar</button>
                                                                                        <button type="submit" class="btn btn-outline-danger" name="accion" value="EliminarSubcategoria">Sí, eliminar</button>
                                                                                    </div>
                                                                                </form>
                                                                            </div>
                                                                        </div>
